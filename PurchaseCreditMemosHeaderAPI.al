page 50102 "APIV2 - Purchase Credit Memos"
{
    PageType = API;
    Caption = 'Custom Purchase Credit Memos';
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                field(documentDate; DocumentDateVar)
                {
                    ...
                    trigger OnValidate()
                    begin
                        IsDocumentDateSet := true;
                        Rec.Validate("Document Date", DocumentDateVar);
                    end;
                }
    ...
    begin
        ...
        if IsDocumentDateSet then begin
            Rec.Validate("Document Date", DocumentDateVar);
            Rec.Modify(true);
        end;
